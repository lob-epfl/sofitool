function [] = setTwoSpacedDiracsEditBoxes(handles)
%Sets the default simulation parameters when only two emitters are present
%
%Inputs:
...
set(handles.startMenu_numAperture_edit,      'String','0.8');
set(handles.startMenu_pixelsY_edit,          'String','30');
set(handles.startMenu_pixelSizeY_edit,       'String','6.45');
set(handles.startMenu_pixelsX_edit,          'String','30');
...
set(handles.startMenu_background_edit,       'String','2');
...
set(handles.startMenu_signal_edit,           'String','200');
set(handles.startMenu_density_edit,          'String','0.53416');
set(handles.startMenu_number_edit,           'String','2');

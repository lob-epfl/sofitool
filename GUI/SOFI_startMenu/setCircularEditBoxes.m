function [] = setCircularEditBoxes(handles)
%Sets the default simulation parameters of emitters distributed in circular
%structures
%
%Inputs:
...
set(handles.startMenu_density_edit,          'String','4.8');
set(handles.startMenu_number_edit,           'String','200');
